      ...
      <div className="flex flex-col relative gap-8">
        ...
        <div className="flex items-center justify-center w-full">
          <label
            ...
            className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-stone-100 dark:bg-gray-700 dark:border-gray-600 dark:hover:border-gray-500 hover:bg-stone-200/50 transition-all duration-250 ease-in-out"
          >
